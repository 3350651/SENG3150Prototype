...
<% if (user == null) { %>
    <div class="createAccount">
        <form method="GET" action="CreateAccount">
            <button name="viewAccountSettings" class="accountButton" value="viewAccountSettings">Create Account</button>
        </form>
    </div>
    <div class="logInToAccount">
        <form method="GET" action="login">
            <button name="viewAccountSettings" class="accountButton" value="viewAccountSettings">Log In</button>
        </form>
    </div>
<% } %>
    </div>
