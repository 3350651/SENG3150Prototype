                                                ...
                                                <%-- Groups You're In --%>
                                                    <% if(user !=null){%>
                                                        ...
                                                        <% if(groups !=null && !groups.isEmpty()){ int
                                                            size=groups.size(); String name="" ; for(int i=0; i < size;
                                                            i++){ GroupBean group=groups.pop();
                                                            ...
                                                            <% groups.addLast(group); } } %>
                                                                <form name="goToGroup" action="CreateGroup"
                                                                    ...
                                                                    <button type="submit" class="button"
                                                                        name="createGroup" value="createGroup">Create
                                                                        New Group</button>
                                                                </form>
                                                        <%}%>
                                    </div>
                                    <div class="main-content">
                                        ...
                                        <div class="simpleSearch">
                                            <form method="POST" action="flightSearch" class="simpleSearchForm">
                                                ...
                                                <div class="arrivalLocation"><label for="arrivalLocation">Going
                                                        To</label><br>
                                                ...
                                                <div class="flexibleDateDiv" id="flexibleDateDiv"><label
                                                    ...
                                                    <div class="flexibleDaysGroup" id="flexibleDaysGroup"
                                                        style="display:none;">
                                                ...
                                                <div class="numberOfAdults"><label for="numberOfAdults">#
                                                        Adults</label><br>
                                                    <input type="number" id="numberOfAdults" size="2"
                                                        name="numberOfAdults">
                                                </div>
                                                <div class="numberOfChildren"><label for="numberOfChildren">#
                                                        Children</label><br>
                                                    <input type="number" id="numberOfChildren" size="2"
                                                        name="numberOfChildren">
                                                </div>
                                                <div style="clear:both;">&nbsp;</div>
                                                <div style="clear:both;">&nbsp;</div>
                                                <div class="saveParam">
                                                    <button name="saveParam" type="submit" value="saveParam"
                                                        class="saveParam">Save
                                            ...
                                            <div class="savedSearches">
                                                ...
                                                <form method="POST" action="Search">
                                                    ...
                                                    <button name="savedParameter" type="submit" value="savedParameter1"
                                                        class="savedParameter">NTL > BNE, 2 adults, 28/12/23
                                                        (+5d)</button><br>
                                                </form>
                                            </div>

                                            <div class="travelHistoryRecWithHeading">
                                                <h2 class="travelHistoryRecommendationHeading"> Based on your recent
                                                    travel </h2>
                                                <div class="travelHistoryRecommendation">
                                                    <div class="flightInfoTravelHistoryRecommendation">
                                                        ...
                                                        <form name="flightActions" class="flightSearchResultButtons"
                                                            ...
                                                            <div class="viewFlightDetailsButtonTravelHistory">
                                                                <button type="submit"
                                                                    class="viewFlightDetailsButtonTravelHistory"
                                                                    name="viewFlightDetails"
                                                                    value="viewFlightDetails">View
                                                                    Details</button>
                                                            </div>
                                                        </form>
