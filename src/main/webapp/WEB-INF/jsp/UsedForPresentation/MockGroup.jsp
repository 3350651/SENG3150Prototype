...
<div class="groupContents">
    <div class="chatAndFaveList">
        ...
        <div class="faveList">
            <p style="font-size: 25px; display:inline-block; margin-block-end: 0em; margin-block-start: 0em;">Group Favourites</p><p style="margin-block-end: 0em; margin-block-start: 0em;" class="material-symbols-outlined">favorite</p>
