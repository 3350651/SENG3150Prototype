...
<div class="gridParent" id="simple">
    ...
    <% int i = 0; for (FlightPathBean flightPath : flightResults1 ) { %>
    ...
    <% i++; }%>
     <% int i = 0; for (FlightPathBean flightPath : flightResults2 ) { %>
            <div class="recResults">
                <div class="FlightSearchResult">
                    <h2></h2>
                    <div class="simpleFlightCardColumn1">
        ...
        <% i++; }%>
         <% int i = 0; for (FlightPathBean flightPath : flightResults3 ) { %>
                <div class="recResults">
                    <div class="FlightSearchResult">
                        <h2></h2>
                        <div class="simpleFlightCardColumn1">
