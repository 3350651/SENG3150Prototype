...
<%--        Favourited Flights         --%>
    ...
    <h2>Bookmarked Flights</h2>
        ...
        <button type="submit" class="button" name="goToBookmarkedFlight3" value="goToBookmarkedFlight2">Brisbane, $662, 26/12/2023</button>
    </form>
<%--        Groups You're In         --%>
    <form name="goToGroup" action="MockupGroup" class="groups" method="POST">
        <h2>Group Membership</h2>
        <button type="submit" class="button" name="goToGroup1" value="goToGroup1">Group</button>
