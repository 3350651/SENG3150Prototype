...
import static seng2050.CommentsBean.findAndDeleteComment;
import static seng2050.IssuesBean.*;
...
public class IssuesServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(person.getRoleInSystem().contains("staff")) {
            ...
            if(returnHomepage){
                List<IssuesBean> staffIssues = getIssuesForIT("SELECT * FROM Issues");
        ...
        //Otherwise, the person is a user.
            ...
            //Return to the homepage.
            if(returnHomepage){
                List<IssuesBean> userIssues = getIssuesForUser("SELECT * FROM Issues", person);
            ...
            //Sort issues in order based off category.
                ...
                List<IssuesBean> staffIssues = getIssuesForUser("SELECT * FROM Issues " +
                        "ORDER BY CASE WHEN issueState = 'NEW' THEN '1' " +
                        "WHEN issueState = 'IN PROGRESS' THEN '2' " +
                        "WHEN issueState = 'WAITING ON THIRD PARTY' THEN '3' " +
                        "WHEN issueState = 'COMPLETED' THEN '4' " +
